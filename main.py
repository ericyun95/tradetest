...
HS_CODE_DB = [
    ...
    # ── 반도체/전자부품 세분화
    {"name": "DRAM",         "code": "854232", "desc": "DRAM 메모리 / DRAM memory chips",
     "kw": ["dram", "메모리반도체", "memory chip", "d램"]},
    {"name": "NAND플래시",   "code": "854232", "desc": "NAND 플래시 메모리 / NAND flash",
     "kw": ["nand", "플래시메모리", "flash memory", "낸드"]},
    {"name": "PCB",          "code": "853400", "desc": "인쇄회로기판 / Printed circuit boards",
     "kw": ["pcb", "인쇄회로기판", "기판", "printed circuit board", "회로기판"]},
    {"name": "커패시터",     "code": "853210", "desc": "커패시터·축전기 / Capacitors",
     "kw": ["커패시터", "콘덴서", "축전기", "capacitor", "mlcc"]},
    {"name": "저항",         "code": "853310", "desc": "저항기 / Resistors",
     "kw": ["저항", "저항기", "resistor", "칩저항"]},
    {"name": "전력반도체",   "code": "854110", "desc": "전력반도체·다이오드 / Power semiconductors",
     "kw": ["전력반도체", "다이오드", "IGBT", "MOSFET", "power semiconductor", "diode"]},
    {"name": "LCD패널",      "code": "900110", "desc": "LCD 디스플레이 / LCD panels",
     "kw": ["lcd", "lcd패널", "액정디스플레이", "lcd display", "액정"]},
    {"name": "터치패널",     "code": "853119", "desc": "터치스크린·패널 / Touch screens",
     "kw": ["터치패널", "터치스크린", "touch screen", "touch panel"]},
    {"name": "충전기",       "code": "850440", "desc": "충전기·어댑터 / Battery chargers & adapters",
     "kw": ["충전기", "어댑터", "charger", "adapter", "무선충전기", "wireless charger"]},
    {"name": "USB",          "code": "847330", "desc": "USB·컴퓨터 부품 / Computer parts & USB",
     "kw": ["usb", "usb허브", "usb드라이브", "flash drive", "usb hub"]},
    {"name": "SSD",          "code": "847130", "desc": "SSD·저장장치 / Solid state drives",
     "kw": ["ssd", "solid state drive", "nvme", "저장장치"]},
    {"name": "CCTV",         "code": "852580", "desc": "CCTV·보안카메라 / Security cameras",
     "kw": ["cctv", "보안카메라", "ip카메라", "security camera", "surveillance"]},
    {"name": "프린터",       "code": "844331", "desc": "프린터·복합기 / Printers",
     "kw": ["프린터", "복합기", "printer", "inkjet", "laser printer"]},
    {"name": "게임기",       "code": "950450", "desc": "게임기·콘솔 / Video game consoles",
     "kw": ["게임기", "콘솔", "게임콘솔", "game console", "ps5", "xbox", "닌텐도"]},

    # ── 자동차 세분화
    {"name": "소형차",       "code": "870321", "desc": "소형 승용차 / Small cars (under 1000cc)",
     "kw": ["소형차", "경차", "small car", "minicar"]},
    {"name": "대형차",       "code": "870324", "desc": "대형 승용차 / Large cars (over 3000cc)",
     "kw": ["대형차", "고급차", "luxury car", "대형세단"]},
    {"name": "SUV",          "code": "870323", "desc": "SUV·RV / SUV & RV vehicles",
     "kw": ["suv", "rv", "크로스오버", "crossover", "4wd"]},
    {"name": "버스",         "code": "870210", "desc": "버스·전기버스 / Buses",
     "kw": ["버스", "전기버스", "bus", "electric bus", "coach"]},
    {"name": "트럭",         "code": "870431", "desc": "화물트럭 / Motor vehicles for goods",
     "kw": ["트럭", "화물차", "truck", "lorry", "freight vehicle"]},
    {"name": "오토바이",     "code": "871190", "desc": "오토바이·모터사이클 / Motorcycles",
     "kw": ["오토바이", "모터사이클", "motorcycle", "scooter", "스쿠터"]},
    {"name": "선박",         "code": "890190", "desc": "선박·화물선 / Ships & cargo vessels",
     "kw": ["선박", "화물선", "컨테이너선", "ship", "vessel", "cargo ship"]},

    # ── 섬유/원단
    {"name": "폴리에스터원단", "code": "540761", "desc": "폴리에스터 직물 / Polyester woven fabrics",
     "kw": ["폴리에스터", "원단", "직물", "polyester fabric", "woven fabric", "textile"]},
    {"name": "나일론원단",   "code": "540710", "desc": "나일론 직물 / Nylon woven fabrics",
     "kw": ["나일론", "나이론", "nylon fabric", "nylon textile"]},
    {"name": "면원단",       "code": "520811", "desc": "면 직물 / Cotton woven fabrics",
     "kw": ["면원단", "면직물", "cotton fabric", "cotton textile"]},
    {"name": "실",           "code": "540110", "desc": "합성섬유사 / Synthetic filament yarn",
     "kw": ["실", "원사", "섬유사", "yarn", "thread", "filament"]},
    {"name": "부직포",       "code": "560311", "desc": "부직포 / Nonwoven fabrics",
     "kw": ["부직포", "nonwoven", "non-woven fabric"]},

    # ── 식품 세분화
    {"name": "불고기소스",   "code": "210390", "desc": "불고기소스·양념 / Bulgogi sauce & seasoning",
     "kw": ["불고기소스", "양념", "소스", "bulgogi sauce", "korean sauce", "marinade"]},
    {"name": "미역",         "code": "121220", "desc": "미역·해조류 / Dried seaweed (wakame)",
     "kw": ["미역", "다시마", "해조류", "wakame", "kelp", "seaweed"]},
    {"name": "참치캔",       "code": "160414", "desc": "참치캔·통조림 / Canned tuna",
     "kw": ["참치캔", "통조림", "참치", "canned tuna", "tuna can"]},
    {"name": "생수",         "code": "220110", "desc": "생수·미네랄워터 / Mineral water",
     "kw": ["생수", "미네랄워터", "mineral water", "bottled water", "음용수"]},
    {"name": "유제품",       "code": "040110", "desc": "우유·유제품 / Milk & dairy products",
     "kw": ["우유", "유제품", "치즈", "버터", "milk", "dairy", "cheese", "butter"]},
    {"name": "계란",         "code": "040700", "desc": "계란·달걀 / Eggs",
     "kw": ["계란", "달걀", "eggs", "egg"]},
    {"name": "꿀",           "code": "040900", "desc": "꿀·천연꿀 / Natural honey",
     "kw": ["꿀", "천연꿀", "honey", "natural honey"]},
    {"name": "올리브오일",   "code": "150910", "desc": "올리브오일 / Olive oil",
     "kw": ["올리브오일", "올리브유", "olive oil"]},
    {"name": "과일주스",     "code": "200981", "desc": "과일주스·착즙 / Fruit juice",
     "kw": ["과일주스", "착즙주스", "fruit juice", "orange juice", "apple juice"]},
    {"name": "떡볶이",       "code": "190230", "desc": "떡볶이·즉석식품 / Tteokbokki instant food",
     "kw": ["떡볶이", "tteokbokki", "즉석떡볶이", "korean street food"]},
    {"name": "김밥",         "code": "190230", "desc": "김밥·즉석밥 / Gimbap & instant rice",
     "kw": ["김밥", "즉석밥", "gimbap", "kimbap", "rice roll"]},
    {"name": "젤리",         "code": "170490", "desc": "젤리·사탕·캔디 / Jelly, candy & sweets",
     "kw": ["젤리", "사탕", "캔디", "jelly", "candy", "gummy", "sweets"]},
    {"name": "고추",         "code": "090421", "desc": "건고추·고춧가루 / Dried chillies",
     "kw": ["고추", "건고추", "고춧가루", "chilli", "pepper", "paprika", "dried chilli"]},
    {"name": "마늘",         "code": "070320", "desc": "마늘 / Garlic",
     "kw": ["마늘", "다진마늘", "garlic", "minced garlic"]},
    {"name": "버섯",         "code": "070951", "desc": "버섯·표고버섯 / Mushrooms",
     "kw": ["버섯", "표고버섯", "느타리버섯", "mushroom", "shiitake", "oyster mushroom"]},
    {"name": "두부",         "code": "210420", "desc": "두부·콩제품 / Tofu & soy products",
     "kw": ["두부", "tofu", "bean curd", "콩제품"]},

    # ── 화장품 세분화
    {"name": "틴트",         "code": "330420", "desc": "틴트·립틴트 / Lip tints",
     "kw": ["틴트", "립틴트", "tint", "lip tint"]},
    {"name": "쿠션팩트",     "code": "330420", "desc": "쿠션·팩트 / Cushion compact",
     "kw": ["쿠션", "쿠션팩트", "팩트", "cushion compact", "cushion foundation"]},
    {"name": "향기제품",     "code": "330749", "desc": "방향제·탈취제 / Air fresheners & deodorizers",
     "kw": ["방향제", "탈취제", "디퓨저", "air freshener", "deodorizer", "diffuser", "방향"]},

    # ── 의료/바이오
    {"name": "진단키트",     "code": "382200", "desc": "진단키트·체외진단 / Diagnostic test kits",
     "kw": ["진단키트", "코로나키트", "신속진단", "diagnostic kit", "rapid test", "covid test", "pcr"]},
    {"name": "수술도구",     "code": "901849", "desc": "수술도구·의료기구 / Surgical instruments",
     "kw": ["수술도구", "의료기구", "surgical instrument", "scalpel", "forceps"]},
    {"name": "혈압계",       "code": "901820", "desc": "혈압계·혈당계 / Blood pressure monitors",
     "kw": ["혈압계", "혈당계", "blood pressure monitor", "glucometer", "혈압측정"]},
    {"name": "초음파기기",   "code": "901812", "desc": "초음파 의료기기 / Ultrasound equipment",
     "kw": ["초음파기기", "ultrasound", "echography", "의료초음파"]},
    {"name": "콘택트렌즈",   "code": "900130", "desc": "콘택트렌즈 / Contact lenses",
     "kw": ["콘택트렌즈", "렌즈", "contact lens", "colored lens", "컬러렌즈"]},
    {"name": "인공관절",     "code": "902190", "desc": "인공관절·임플란트 / Orthopedic implants",
     "kw": ["인공관절", "임플란트", "인공뼈", "orthopedic implant", "prosthetics"]},
    {"name": "치과재료",     "code": "902121", "desc": "치과재료·임플란트 / Dental implants & materials",
     "kw": ["치과재료", "치과임플란트", "dental implant", "dental material", "치과"]},

    # ── 에너지/환경
    {"name": "풍력발전기",   "code": "850231", "desc": "풍력발전기 / Wind turbine generators",
     "kw": ["풍력발전기", "풍력", "wind turbine", "wind generator", "wind energy"]},
    {"name": "에너지저장장치", "code": "850760", "desc": "ESS·에너지저장 / Energy storage systems",
     "kw": ["ess", "에너지저장장치", "energy storage", "배터리시스템", "battery system"]},
    {"name": "수소",         "code": "280410", "desc": "수소·연료전지 / Hydrogen & fuel cells",
     "kw": ["수소", "수소연료", "연료전지", "hydrogen", "fuel cell", "수소에너지"]},
    {"name": "정수기",       "code": "842121", "desc": "정수기·수처리 / Water purifiers",
     "kw": ["정수기", "수처리", "water purifier", "water filter", "정수"]},

    # ── 건설/건자재 세분화
    {"name": "엘리베이터",   "code": "842810", "desc": "엘리베이터·에스컬레이터 / Elevators & escalators",
     "kw": ["엘리베이터", "에스컬레이터", "elevator", "escalator", "lift"]},
    {"name": "에어컨부품",   "code": "841590", "desc": "에어컨 부품·냉동부품 / AC & refrigeration parts",
     "kw": ["에어컨부품", "냉동부품", "ac parts", "refrigeration parts", "hvac"]},
    {"name": "방수재",       "code": "382430", "desc": "방수재·실란트 / Waterproofing & sealants",
     "kw": ["방수재", "실란트", "방수", "waterproofing", "sealant", "caulk"]},
    {"name": "단열재",       "code": "680610", "desc": "단열재·보온재 / Insulation materials",
     "kw": ["단열재", "보온재", "insulation", "thermal insulation", "단열"]},

    # ── 물류/유통장비
    {"name": "지게차",       "code": "842710", "desc": "지게차·포크리프트 / Fork-lift trucks",
     "kw": ["지게차", "포크리프트", "forklift", "fork-lift", "전동지게차"]},
    {"name": "컨베이어",     "code": "842830", "desc": "컨베이어 / Conveyors",
     "kw": ["컨베이어", "컨베이어벨트", "conveyor", "conveyor belt"]},
    {"name": "금고",         "code": "830310", "desc": "금고·보안장비 / Safes & security equipment",
     "kw": ["금고", "safe", "vault", "보안금고"]},
    {"name": "냉동냉장창고", "code": "841830", "desc": "냉동장비·냉장창고 / Freezing equipment",
     "kw": ["냉동창고", "냉장창고", "냉동장비", "cold storage", "freezer", "refrigeration unit"]},

    # ── 소비재 기타
    {"name": "안경",         "code": "900410", "desc": "안경·선글라스 / Spectacles & sunglasses",
     "kw": ["안경", "선글라스", "glasses", "spectacles", "sunglasses", "eyewear"]},
    {"name": "시계",         "code": "910211", "desc": "손목시계 / Wristwatches",
     "kw": ["시계", "손목시계", "watch", "wristwatch", "시계줄"]},
    {"name": "가방끈",       "code": "420212", "desc": "여행가방·캐리어 / Trunks & suitcases",
     "kw": ["여행가방", "캐리어", "트렁크", "suitcase", "luggage", "travel bag", "캐리어백"]},
    {"name": "우산",         "code": "660110", "desc": "우산·양산 / Umbrellas",
     "kw": ["우산", "양산", "umbrella", "parasol"]},
    {"name": "침대",         "code": "940310", "desc": "침대·금속가구 / Metal furniture & beds",
     "kw": ["침대", "bed", "metal bed", "bunk bed", "이층침대"]},
    {"name": "소파",         "code": "940161", "desc": "소파·쇼파 / Sofas & settees",
     "kw": ["소파", "쇼파", "sofa", "couch", "settee", "리클라이너"]},
    {"name": "커튼",         "code": "630312", "desc": "커튼·블라인드 / Curtains & blinds",
     "kw": ["커튼", "블라인드", "curtain", "blind", "roller blind"]},
    {"name": "카펫",         "code": "570110", "desc": "카펫·러그 / Carpets & rugs",
     "kw": ["카펫", "러그", "carpet", "rug", "mat", "매트"]},
    {"name": "수건",         "code": "630260", "desc": "수건·타월 / Towels",
     "kw": ["수건", "타월", "towel", "bath towel", "hand towel"]},
    {"name": "화분",         "code": "690900", "desc": "화분·도자기용기 / Ceramic pots & containers",
     "kw": ["화분", "flower pot", "planter", "도자화분"]},

    # ── 농기계
    {"name": "트랙터",       "code": "870191", "desc": "트랙터·농업기계 / Agricultural tractors",
     "kw": ["트랙터", "농기계", "tractor", "agricultural machine", "경운기"]},
    {"name": "이앙기",       "code": "843351", "desc": "이앙기·수확기 / Rice transplanters & harvesters",
     "kw": ["이앙기", "콤바인", "수확기", "rice transplanter", "harvester", "combine"]},

    # ── 방위/항공
    {"name": "항공기부품",   "code": "880330", "desc": "항공기 부품 / Aircraft parts",
     "kw": ["항공기부품", "aircraft parts", "항공부품", "aerospace parts"]},
    ...
    {"name": "K팝음반",      "code": "852352", "desc": "음반·CD·DVD / Music CDs & DVDs",
     "kw": ["음반", "cd", "dvd", "k팝", "kpop", "music album", "앨범"]},
    {"name": "웹툰",         "code": "490199", "desc": "만화·웹툰·콘텐츠 / Comics & digital content",
     "kw": ["웹툰", "만화", "webtoon", "comic", "manhwa"]},
]
